...
QuickMenu.presets12 = { 
	slots = {
		[12] = "TfcExtension(ReloadUI)",
		[11] = "TfcExtension(DismissAllPets)",
		[7] = "TfcExtension(GroupUp)",
		[8] = SI_MAIN_MENU_ACTIVITY_FINDER,
		[3] = "TfcExtension(TravelToRM)",
		[2] = "TfcExtension(TravelToER)",
		[9] = SI_JOURNAL_MENU_QUESTS,
		[13] = SI_GAME_MENU_QUIT,
		[5] = "TfcExtension(TravelToSpouse)",
		[6] = "TfcExtension(TravelToLeader)",
		[4] = "TfcExtension(LeaveDisbandGroup)",
        [10] = SI_JOURNAL_MENU_ACHIEVEMENTS,
        [1] = "TfcExtension(LeaveInstance)",
	},
	slotsCount = 14
}
